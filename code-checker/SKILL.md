---
name: code-checker
description: Use when reviewing code for bugs, security vulnerabilities, test coverage, code quality issues, and correctness verification before merging or deploying
---
