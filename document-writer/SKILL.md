...
description: Use when creating academic papers, reports, or professional PDFs using the pandoc-based document generation system with draft workflow, presets, and compilation tools
---
...
â†’ docs_draft(title="Transformer Architecture Report", preset="school-report")
â†’ Returns: Document ID: bright-tide-128

User: "Add a conclusion section"
â†’ edit .opencode/docs/bright-tide-128/draft.md
â†’ Add ## Conclusion with content

User: "Make it the UofG version"
â†’ docs_compile(doc_id="bright-tide-128", logo="uofg", course="CS224N")

User: "Also make an SIT version"
â†’ docs_compile(doc_id="bright-tide-128", logo="sit", course="CS224N")

User: "Done, clean up"
â†’ docs_delete_draft(doc_id="bright-tide-128")
```
