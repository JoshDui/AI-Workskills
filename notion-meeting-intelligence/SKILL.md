...
**Decision Meeting**: Meeting Details â†’ Objective â†’ Options (Pros/Cons) â†’ Recommendation â†’ Discussion â†’ Decision â†’ Action Items

**Status Update**: Meeting Details â†’ Project Status â†’ Progress â†’ Upcoming Work â†’ Blockers â†’ Discussion â†’ Action Items

**Customer/External**: Meeting Details â†’ Objective â†’ Agenda Items (timed) â†’ Discussion Topics â†’ Next Steps

**Brainstorming**: Meeting Details â†’ Objective â†’ Constraints â†’ Ideas â†’ Discussion â†’ Next Steps
...
**Day-Before** (next-day meetings): Gather context â†’ create agenda â†’ share with attendees â†’ allow review time
**Hour-Before** (last-minute): Quick context â†’ brief pre-read â†’ basic agenda â†’ essentials only
**Week-Before** (major meetings): Comprehensive research â†’ detailed pre-read â†’ structured agenda â†’ pre-meeting reviews
