...
description: Use only when the user explicitly asks about the Superpowers skill workflow, porting Superpowers behavior, or how to use these imported Superpowers skills in Codex.
---
