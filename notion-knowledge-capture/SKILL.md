...
**Concept**: Overview â†’ Definition â†’ Characteristics â†’ Examples â†’ Use Cases â†’ Related
**How-To**: Overview â†’ Prerequisites â†’ Steps (numbered) â†’ Verification â†’ Troubleshooting â†’ Related
**Decision**: Context â†’ Decision â†’ Rationale â†’ Options Considered â†’ Consequences â†’ Implementation
**FAQ**: Short Answer â†’ Detailed Explanation â†’ Examples â†’ When to Use â†’ Related Questions
**Learning**: What Happened â†’ What Went Well â†’ What Didn't â†’ Root Causes â†’ Learnings â†’ Actions

## Destination Patterns

**General Wiki**: Standalone page â†’ add to index â†’ tag â†’ link from related pages

**Project Wiki**: Child of project page â†’ link from project overview â†’ tag with project name
