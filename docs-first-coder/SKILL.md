---
name: docs-first-coder
description: Use when writing code that involves library APIs, framework features, SDKs, or any technology where current documentation should be consulted before implementation to avoid outdated patterns
---
