---
name: brainstorming
description: Use when the user explicitly asks for the Superpowers brainstorming workflow before creative product, feature, component, or behavior design work.
---
